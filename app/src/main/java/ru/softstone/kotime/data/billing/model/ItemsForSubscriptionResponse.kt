package ru.softstone.kotime.data.billing.model

import com.android.billingclient.api.BillingClient
import com.android.billingclient.api.SkuDetails

sealed class ItemsForSubscriptionResponse(
    @BillingClient.BillingResponse val result: Int?,
    val skuDetails: List<SkuDetails>? = null
) {

    data class ItemsForSubscriptionSuccess(
    ...
    data class ItemsForSubscriptionFailure(
        @BillingClient.BillingResponse
